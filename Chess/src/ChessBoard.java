    ...
    public boolean moveToPosition(int startLine, int startColumn, int endLine, int endColumn) {
        if (checkPos(startLine) && checkPos(startColumn)) {
            ...
            if (board[startLine][startColumn].canMoveToPosition(this, startLine, startColumn, endLine, endColumn)) {
                ...
                //Превращение белой пешки в королеву
                if (endLine == 7 && board[startLine][startColumn].getColor().equals("White") &&
                        board[startLine][startColumn].getSymbol().equals("P")) {
                    board[endLine][endColumn] = new Queen("White");
                }
                //Превращение черной пешки в королеву
                else if (endLine == 0 && board[startLine][startColumn].getColor().equals("Black") &&
                        board[startLine][startColumn].getSymbol().equals("P")) {
                    board[endLine][endColumn] = new Queen("Black");
                } else {
                    board[endLine][endColumn] = board[startLine][startColumn];// if piece can move, we moved a piece
                }
                board[startLine][startColumn] = null; // set null to previous cell

                // Информирование атаки короля
                boolean z = true;
                for (int i = 0; i <= 7 && z; i++) {
                    for (int j = 0; j <= 7 && z; j++) {
                        if (board[i][j] != null && board[i][j].getSymbol().equals("K") && !(board[i][j].getColor().equals(this.nowPlayerColor()))) {
        ...
        if (nowPlayer.equals("White")) {
            ...
            if (board[0][0].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") && // check that King and Rook
                ...
                if (board[0][0].getColor().equals("White") && board[0][4].getColor().equals("White") &&
                        ...
                        !new King("White").isUnderAttack(this, 0, 4) &&
                        !new King("White").isUnderAttackAfterCastling(this, 0, 2)) {
                    board[0][4] = null;
            ...
            if (board[7][0].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") && // check that King and Rook
                ...
                if (board[7][0].getColor().equals("Black") && board[7][4].getColor().equals("Black") &&
                        ...
                        !new King("Black").isUnderAttack(this, 7, 4) &&
                        !new King("Black").isUnderAttackAfterCastling(this, 7, 2)) { // check that position not in under attack
                    board[7][4] = null;
        ...
        if (nowPlayer.equals("White")) {
            ...
            if (board[0][7].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") && // check that King and Rook
                ...
                if (board[0][7].getColor().equals("White") && board[0][4].getColor().equals("White") &&
                        ...
                        !new King("White").isUnderAttack(this, 0, 4) &&
                        !new King("White").isUnderAttackAfterCastling(this, 0, 6)) { // check that position not in under attack
                    board[0][4] = null;
            ...
            if (board[7][7].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") && // check that King and Rook
                ...
                if (board[7][7].getColor().equals("Black") && board[7][4].getColor().equals("Black") &&
                        ...
                        !new King("Black").isUnderAttack(this, 7, 4) &&
                        !new King("Black").isUnderAttackAfterCastling(this, 7, 6)) { // check that position not in under attack
                    board[7][4] = null;
